...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void FuncTest()
        {
            var finish = false;
            IRuleFactory<string, string> factory = new RuleFactory<string, string>();
            factory.RegisterFunc<Profile>("1", p => p.Age > 20 && p.Name == "Ricky" && p.Sex == "男", "His name is Ricky and he is a more than 20 years old", "Less than 30");
            var observable = factory.Apply("1", new Profile()
            {
                Name = "Ricky",
                Age = 25,
        ...
        [TestMethod]
        public void StringFuncWithoutRegister()
        {
            var finish = false;
            IRuleFactory<string, string> factory = new RuleFactory<string, string>();
